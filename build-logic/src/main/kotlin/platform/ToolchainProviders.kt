...
open class ToolchainProviders(private val project: Project) {
    ...
    fun commandExists(cmd: String, vararg args: String): Provider<Boolean> {
        ...
        return project.providers.of(CommandExistsValueSource::class.java, Action<ValueSourceSpec<CommandExistsValueSource.Parameters>> {
    ...
    val linuxX64OnMac: Provider<Boolean> by lazy {
        project.providers.provider {
            Host.isMac && (
                commandExists("x86_64-linux-gnu-gcc").get() ||
                commandExists("x86_64-linux-musl-gcc").get() ||
                hasZig.get() ||
                commandExists("clang").get() ||
                commandExists("aarch64-unknown-linux-gnu-gcc").get()
            )
        }
    }
    ...
    fun getEmscriptenRoot(): Provider<String> {
        ...
        return project.providers.of(EmscriptenRootValueSource::class.java, Action<ValueSourceSpec<EmscriptenRootValueSource.Parameters>> {
    ...
    fun findEmscriptenToolchain(): Provider<String> {
        ...
        return project.providers.of(EmscriptenToolchainValueSource::class.java, Action<ValueSourceSpec<EmscriptenToolchainValueSource.Parameters>> {
    ...
    fun getLlvmNm(): Provider<String> {
        ...
        val emRootProvider = getEmscriptenRoot()
        return project.providers.of(LlvmNmValueSource::class.java, Action<ValueSourceSpec<LlvmNmValueSource.Parameters>> {
            parameters.emscriptenRoot.set(emRootProvider)
...
val Project.toolchains: ToolchainProviders
    get() = extensions.findByType(ToolchainProviders::class.java)
        ?: extensions.create("toolchains", ToolchainProviders::class.java, this)
