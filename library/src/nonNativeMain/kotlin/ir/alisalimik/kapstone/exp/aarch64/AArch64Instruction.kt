...
actual enum class AArch64Instruction(override val value: Int) : INumericEnum {
  ...
  ALIAS_ADDS(AARCH64_INS_ALIAS_ADDS),
  ...
  ALIAS_ST1W(AARCH64_INS_ALIAS_ST1W),
  ...
  ALIAS_ST2B(AARCH64_INS_ALIAS_ST2B),
  ...
  ALIAS_LD1RSH(AARCH64_INS_ALIAS_LD1RSH),
  ALIAS_LD1RSB(AARCH64_INS_ALIAS_LD1RSB),
  ...
  ALIAS_STUMAX(AARCH64_INS_ALIAS_STUMAX),
  UADDLP(AARCH64_INS_UADDLP),
  UADDLT(AARCH64_INS_UADDLT),
  ALIAS_LDTRSW(AARCH64_INS_ALIAS_LDTRSW),
  ALIAS_SQINCH(AARCH64_INS_ALIAS_SQINCH),
  LDSETAB(AARCH64_INS_LDSETAB),
  STXR(AARCH64_INS_STXR),
  CPYFEWTWN(AARCH64_INS_CPYFEWTWN),
  MUL(AARCH64_INS_MUL),
  ALIAS_STCLRL(AARCH64_INS_ALIAS_STCLRL),
  ...
  ALIAS_MNEG(AARCH64_INS_ALIAS_MNEG),
  ...
  ALIAS_PACIB1716(AARCH64_INS_ALIAS_PACIB1716),
  SQXTNT(AARCH64_INS_SQXTNT),
  CPYFETN(AARCH64_INS_CPYFETN),
  SSUBLTB(AARCH64_INS_SSUBLTB),
  ALIAS_NGC(AARCH64_INS_ALIAS_NGC),
  ALIAS_CSET(AARCH64_INS_ALIAS_CSET),
  ...
  ALIAS_LDFF1H(AARCH64_INS_ALIAS_LDFF1H),
  USUBWT(AARCH64_INS_USUBWT),
  ALIAS_LD4D(AARCH64_INS_ALIAS_LD4D),
  ...
  ALIAS_STTR(AARCH64_INS_ALIAS_STTR),
  ...
  ALIAS_STLURB(AARCH64_INS_ALIAS_STLURB),
  ALIAS_STGP(AARCH64_INS_ALIAS_STGP),
  ALIAS_AND(AARCH64_INS_ALIAS_AND),
  ALIAS_SUB(AARCH64_INS_ALIAS_SUB),
  ALIAS_DUPM(AARCH64_INS_ALIAS_DUPM),
  LDUR(AARCH64_INS_LDUR),
  BFCVTN(AARCH64_INS_BFCVTN),
  BLRABZ(AARCH64_INS_BLRABZ),
  ALIAS_STCLRB(AARCH64_INS_ALIAS_STCLRB),
  ALIAS_AUTIA1716(AARCH64_INS_ALIAS_AUTIA1716),
  ...
  ALIAS_LD1(AARCH64_INS_ALIAS_LD1),
  ...
  ALIAS_LDURSH(AARCH64_INS_ALIAS_LDURSH),
  ...
  ALIAS_MOVN(AARCH64_INS_ALIAS_MOVN),
  ...
  ALIAS_UQDECB(AARCH64_INS_ALIAS_UQDECB),
  LDCLRAB(AARCH64_INS_LDCLRAB),
  REVB(AARCH64_INS_REVB),
  ALIAS_STLR(AARCH64_INS_ALIAS_STLR),
  LDCLRL(AARCH64_INS_LDCLRL),
  ALIAS_STURH(AARCH64_INS_ALIAS_STURH),
  BFCVT(AARCH64_INS_BFCVT),
  SQDMLSL(AARCH64_INS_SQDMLSL),
  ALIAS_CNTW(AARCH64_INS_ALIAS_CNTW),
  CLR(AARCH64_INS_CLR),
  BIT(AARCH64_INS_BIT),
  ...
  ALIAS_UMULL(AARCH64_INS_ALIAS_UMULL),
  ALIAS_LD2D(AARCH64_INS_ALIAS_LD2D),
  ALIAS_STUMAXH(AARCH64_INS_ALIAS_STUMAXH),
  HISTSEG(AARCH64_INS_HISTSEG),
  LDCLRAL(AARCH64_INS_LDCLRAL),
  ALIAS_STUMAXB(AARCH64_INS_ALIAS_STUMAXB),
  SQABS(AARCH64_INS_SQABS),
  WHILELO(AARCH64_INS_WHILELO),
  ALIAS_LD2B(AARCH64_INS_ALIAS_LD2B),
  XAFLAG(AARCH64_INS_XAFLAG),
  ALIAS_LDRSH(AARCH64_INS_ALIAS_LDRSH),
  ALIAS_STUMINL(AARCH64_INS_ALIAS_STUMINL),
  LD64B(AARCH64_INS_LD64B),
  LDEORA(AARCH64_INS_LDEORA),
  ALIAS_LD2H(AARCH64_INS_ALIAS_LD2H),
  LD3B(AARCH64_INS_LD3B),
  SB(AARCH64_INS_SB),
  ALIAS_CSETM(AARCH64_INS_ALIAS_CSETM),
  ...
  ALIAS_LDFF1SB(AARCH64_INS_ALIAS_LDFF1SB),
  LDG(AARCH64_INS_LDG),
  ALIAS_RPRFM(AARCH64_INS_ALIAS_RPRFM),
  ALIAS_ST4W(AARCH64_INS_ALIAS_ST4W),
  ALIAS_LDTR(AARCH64_INS_ALIAS_LDTR),
  FMLSLB(AARCH64_INS_FMLSLB),
  PACIB171615(AARCH64_INS_PACIB171615),
  ALIAS_TST(AARCH64_INS_ALIAS_TST),
  ...
  ALIAS_NBSL(AARCH64_INS_ALIAS_NBSL),
  ...
  ALIAS_PACIBSP(AARCH64_INS_ALIAS_PACIBSP),
  MADPT(AARCH64_INS_MADPT),
  ALIAS_BCAX(AARCH64_INS_ALIAS_BCAX),
  ...
  ALIAS_STEORL(AARCH64_INS_ALIAS_STEORL),
  ST4(AARCH64_INS_ST4),
  ...
  ALIAS_SEVL(AARCH64_INS_ALIAS_SEVL),
  ...
  ALIAS_AUTIBSP(AARCH64_INS_ALIAS_AUTIBSP),
  ...
  ALIAS_LDNF1B(AARCH64_INS_ALIAS_LDNF1B),
  ALIAS_WFE(AARCH64_INS_ALIAS_WFE),
  UMULLT(AARCH64_INS_UMULLT),
  ALIAS_BSL1N(AARCH64_INS_ALIAS_BSL1N),
  ALIAS_ST3(AARCH64_INS_ALIAS_ST3),
  ALIAS_ST2(AARCH64_INS_ALIAS_ST2),
  LDADDLB(AARCH64_INS_LDADDLB),
  ALIAS_LD1RQD(AARCH64_INS_ALIAS_LD1RQD),
  ALIAS_STZG(AARCH64_INS_ALIAS_STZG),
  ALIAS_STUMAXLH(AARCH64_INS_ALIAS_STUMAXLH),
  ALIAS_ST4B(AARCH64_INS_ALIAS_ST4B),
  CPYFMRTN(AARCH64_INS_CPYFMRTN),
  EOR(AARCH64_INS_EOR),
  ALIAS_STSMAXLH(AARCH64_INS_ALIAS_STSMAXLH),
  SETPN(AARCH64_INS_SETPN),
  GMI(AARCH64_INS_GMI),
  ALIAS_LD1H(AARCH64_INS_ALIAS_LD1H),
  ALIAS_STSETB(AARCH64_INS_ALIAS_STSETB),
  ALIAS_LD1D(AARCH64_INS_ALIAS_LD1D),
  ...
  ALIAS_LDFF1SW(AARCH64_INS_ALIAS_LDFF1SW),
  ...
  ALIAS_STTRH(AARCH64_INS_ALIAS_STTRH),
  ALIAS_ST3W(AARCH64_INS_ALIAS_ST3W),
  ...
  ALIAS_SMULL(AARCH64_INS_ALIAS_SMULL),
  ALIAS_AUTIASP(AARCH64_INS_ALIAS_AUTIASP),
  ALIAS_DECW(AARCH64_INS_ALIAS_DECW),
  ...
  ALIAS_PTRUES(AARCH64_INS_ALIAS_PTRUES),
  ...
  ALIAS_BSL(AARCH64_INS_ALIAS_BSL),
  ...
  ALIAS_STTRB(AARCH64_INS_ALIAS_STTRB),
  XAR(AARCH64_INS_XAR),
  RCWSCASPL(AARCH64_INS_RCWSCASPL),
  USHLLT(AARCH64_INS_USHLLT),
  ALIAS_LDNP(AARCH64_INS_ALIAS_LDNP),
  SMAX(AARCH64_INS_SMAX),
  PTRUE(AARCH64_INS_PTRUE),
  ALIAS_LDAPURH(AARCH64_INS_ALIAS_LDAPURH),
  TBXQ(AARCH64_INS_TBXQ),
  SETE(AARCH64_INS_SETE),
  LD1B(AARCH64_INS_LD1B),
  ALIAS_STEORLB(AARCH64_INS_ALIAS_STEORLB),
  ALIAS_LDNF1W(AARCH64_INS_ALIAS_LDNF1W),
  RCWCAS(AARCH64_INS_RCWCAS),
  CTERMNE(AARCH64_INS_CTERMNE),
  ALIAS_LDNT1W(AARCH64_INS_ALIAS_LDNT1W),
  ADD(AARCH64_INS_ADD),
  ...
  ALIAS_XPACLRI(AARCH64_INS_ALIAS_XPACLRI),
  ...
  ALIAS_PACIA1716(AARCH64_INS_ALIAS_PACIA1716),
  ...
  ALIAS_MOVZ(AARCH64_INS_ALIAS_MOVZ),
  ...
  ALIAS_LDURB(AARCH64_INS_ALIAS_LDURB),
  ...
  IRG(AARCH64_INS_IRG),
  ALIAS_NEGS(AARCH64_INS_ALIAS_NEGS),
  ...
  ALIAS_STEORB(AARCH64_INS_ALIAS_STEORB),
  ...
  ALIAS_LD1ROW(AARCH64_INS_ALIAS_LD1ROW),
  ...
  ALIAS_STSET(AARCH64_INS_ALIAS_STSET),
  LD1RQB(AARCH64_INS_LD1RQB),
  MAC16(AARCH64_INS_MAC16),
  SABDL(AARCH64_INS_SABDL),
  ALIAS_ST3B(AARCH64_INS_ALIAS_ST3B),
  ALIAS_DGH(AARCH64_INS_ALIAS_DGH),
  ...
  ALIAS_LDRSW(AARCH64_INS_ALIAS_LDRSW),
  ALIAS_CSDB(AARCH64_INS_ALIAS_CSDB),
  STLURH(AARCH64_INS_STLURH),
  SVDOT(AARCH64_INS_SVDOT),
  ALIAS_YIELD(AARCH64_INS_ALIAS_YIELD),
  ...
  ALIAS_LD4R(AARCH64_INS_ALIAS_LD4R),
  CPY(AARCH64_INS_CPY),
  ...
  ALIAS_ST2H(AARCH64_INS_ALIAS_ST2H),
  SHA512H2(AARCH64_INS_SHA512H2),
  ALIAS_ANDS(AARCH64_INS_ALIAS_ANDS),
  ALIAS_LDFF1B(AARCH64_INS_ALIAS_LDFF1B),
  ...
  ALIAS_PACIBZ(AARCH64_INS_ALIAS_PACIBZ),
  SQDMLALBT(AARCH64_INS_SQDMLALBT),
  MSB(AARCH64_INS_MSB),
  ALIAS_MOV(AARCH64_INS_ALIAS_MOV),
  ...
  ALIAS_LDRSB(AARCH64_INS_ALIAS_LDRSB),
  ALIAS_STURB(AARCH64_INS_ALIAS_STURB),
  RCWSCLR(AARCH64_INS_RCWSCLR),
  ALIAS_STLLR(AARCH64_INS_ALIAS_STLLR),
  LDAP1(AARCH64_INS_LDAP1),
  CLASTA(AARCH64_INS_CLASTA),
  RCWSETP(AARCH64_INS_RCWSETP),
  UADDW(AARCH64_INS_UADDW),
  ALIAS_ADDPT(AARCH64_INS_ALIAS_ADDPT),
  ALIAS_LDRAA(AARCH64_INS_ALIAS_LDRAA),
  SUBP(AARCH64_INS_SUBP),
  SABALT(AARCH64_INS_SABALT),
  ALIAS_STRB(AARCH64_INS_ALIAS_STRB),
  ...
  ALIAS_SXTW(AARCH64_INS_ALIAS_SXTW),
  ...
  ALIAS_ORR_8H(AARCH64_INS_ALIAS_ORR_8H),
  DUP(AARCH64_INS_DUP),
  ALIAS_NGCS(AARCH64_INS_ALIAS_NGCS),
  ...
  ALIAS_LDAPUR(AARCH64_INS_ALIAS_LDAPUR),
  ALIAS_LDFF1SH(AARCH64_INS_ALIAS_LDFF1SH),
  URHADD(AARCH64_INS_URHADD),
  SSUBLBT(AARCH64_INS_SSUBLBT),
  UMLSL2(AARCH64_INS_UMLSL2),
  ST3(AARCH64_INS_ST3),
  ALIAS_SXTL2_8H(AARCH64_INS_ALIAS_SXTL2_8H),
  LDXRB(AARCH64_INS_LDXRB),
  ALIAS_BICS(AARCH64_INS_ALIAS_BICS),
  ORN(AARCH64_INS_ORN),
  ALIAS_STSETLB(AARCH64_INS_ALIAS_STSETLB),
  SQSHRNB(AARCH64_INS_SQSHRNB),
  GCSSTR(AARCH64_INS_GCSSTR),
  ALIAS_STSMINH(AARCH64_INS_ALIAS_STSMINH),
  ALIAS_LD3H(AARCH64_INS_ALIAS_LD3H),
  ...
  ALIAS_UQINCH(AARCH64_INS_ALIAS_UQINCH),
  SQDMLALT(AARCH64_INS_SQDMLALT),
  FMLALLTB(AARCH64_INS_FMLALLTB),
  ALIAS_LDR(AARCH64_INS_ALIAS_LDR),
  LDEORLH(AARCH64_INS_LDEORLH),
  STTR(AARCH64_INS_STTR),
  ALIAS_LD1ROB(AARCH64_INS_ALIAS_LD1ROB),
  ALIAS_UQINCB(AARCH64_INS_ALIAS_UQINCB),
  ALIAS_LDP(AARCH64_INS_ALIAS_LDP),
  ALIAS_UQINCD(AARCH64_INS_ALIAS_UQINCD),
  FVDOT(AARCH64_INS_FVDOT),
  XPACD(AARCH64_INS_XPACD),
  ALIAS_LDTRB(AARCH64_INS_ALIAS_LDTRB),
  ...
  ALIAS_STL1(AARCH64_INS_ALIAS_STL1),
  ...
  ALIAS_LD1ROD(AARCH64_INS_ALIAS_LD1ROD),
  SDIV(AARCH64_INS_SDIV),
  RCWSSET(AARCH64_INS_RCWSSET),
  SMSUBL(AARCH64_INS_SMSUBL),
  ALIAS_LD1ROH(AARCH64_INS_ALIAS_LD1ROH),
  ...
  ALIAS_STSMINL(AARCH64_INS_ALIAS_STSMINL),
  RPRFM(AARCH64_INS_RPRFM),
  ALIAS_LD3D(AARCH64_INS_ALIAS_LD3D),
  ...
  ALIAS_LDTRSB(AARCH64_INS_ALIAS_LDTRSB),
  INDEX(AARCH64_INS_INDEX),
  ALIAS_LDNF1SH(AARCH64_INS_ALIAS_LDNF1SH),
  ALIAS_CNTD(AARCH64_INS_ALIAS_CNTD),
  INCW(AARCH64_INS_INCW),
  RADDHN2(AARCH64_INS_RADDHN2),
  WHILEHS(AARCH64_INS_WHILEHS),
  LDUMAXH(AARCH64_INS_LDUMAXH),
  ALIAS_SMSTART(AARCH64_INS_ALIAS_SMSTART),
  SQSHRNT(AARCH64_INS_SQSHRNT),
  SHSUBR(AARCH64_INS_SHSUBR),
  ALIAS_ST1H(AARCH64_INS_ALIAS_ST1H),
  ...
  ALIAS_UXTL(AARCH64_INS_ALIAS_UXTL),
  ...
  ALIAS_INCD(AARCH64_INS_ALIAS_INCD),
  ALIAS_LDTRSH(AARCH64_INS_ALIAS_LDTRSH),
  ALIAS_PRFW(AARCH64_INS_ALIAS_PRFW),
  ALIAS_UXTB(AARCH64_INS_ALIAS_UXTB),
  ALIAS_SXTB(AARCH64_INS_ALIAS_SXTB),
  ALIAS_SQINCW(AARCH64_INS_ALIAS_SQINCW),
  SADDV(AARCH64_INS_SADDV),
  UQXTNT(AARCH64_INS_UQXTNT),
  BFMLSLB(AARCH64_INS_BFMLSLB),
  UABD(AARCH64_INS_UABD),
  ALIAS_STLRH(AARCH64_INS_ALIAS_STLRH),
  ...
  ALIAS_LDFF1W(AARCH64_INS_ALIAS_LDFF1W),
  ALIAS_LDTRH(AARCH64_INS_ALIAS_LDTRH),
  ALIAS_SXTL2(AARCH64_INS_ALIAS_SXTL2),
  ALIAS_LD3R(AARCH64_INS_ALIAS_LD3R),
  SQADD(AARCH64_INS_SQADD),
  BLRAB(AARCH64_INS_BLRAB),
  BRAB(AARCH64_INS_BRAB),
  LDEORLB(AARCH64_INS_LDEORLB),
  LDZI(AARCH64_INS_LDZI),
  ALIAS_STSMAXL(AARCH64_INS_ALIAS_STSMAXL),
  RADDHNB(AARCH64_INS_RADDHNB),
  ALIAS_SUBS(AARCH64_INS_ALIAS_SUBS),
  ALIAS_UXTL_4S(AARCH64_INS_ALIAS_UXTL_4S),
  FCMGE(AARCH64_INS_FCMGE),
  MSUB(AARCH64_INS_MSUB),
  ALIAS_STILP(AARCH64_INS_ALIAS_STILP),
  ...
  ALIAS_LD2Q(AARCH64_INS_ALIAS_LD2Q),
  ALIAS_STSMINB(AARCH64_INS_ALIAS_STSMINB),
  ...
  ALIAS_MOVS(AARCH64_INS_ALIAS_MOVS),
  FCVTNB(AARCH64_INS_FCVTNB),
  SETGMT(AARCH64_INS_SETGMT),
  TBZ(AARCH64_INS_TBZ),
  SHA1M(AARCH64_INS_SHA1M),
  ALIAS_LD2(AARCH64_INS_ALIAS_LD2),
  ALIAS_LD4(AARCH64_INS_ALIAS_LD4),
  ...
  ALIAS_STP(AARCH64_INS_ALIAS_STP),
  ...
  ALIAS_SXTH(AARCH64_INS_ALIAS_SXTH),
  ...
  ALIAS_LDRB(AARCH64_INS_ALIAS_LDRB),
  CPYFPTWN(AARCH64_INS_CPYFPTWN),
  ALIAS_LD4Q(AARCH64_INS_ALIAS_LD4Q),
  DECH(AARCH64_INS_DECH),
  ALIAS_BIC(AARCH64_INS_ALIAS_BIC),
  ...
  ALIAS_UXTL2_2D(AARCH64_INS_ALIAS_UXTL2_2D),
  SQRSHLR(AARCH64_INS_SQRSHLR),
  BFMAXNM(AARCH64_INS_BFMAXNM),
  BGRP(AARCH64_INS_BGRP),
  ALIAS_PRFM(AARCH64_INS_ALIAS_PRFM),
  ALIAS_STCLR(AARCH64_INS_ALIAS_STCLR),
  RCWSSWPPL(AARCH64_INS_RCWSSWPPL),
  ALIAS_STADD(AARCH64_INS_ALIAS_STADD),
  ...
  ALIAS_SQDECB(AARCH64_INS_ALIAS_SQDECB),
  UQRSHRNB(AARCH64_INS_UQRSHRNB),
  ALIAS_ST1D(AARCH64_INS_ALIAS_ST1D),
  ...
  ALIAS_NOT(AARCH64_INS_ALIAS_NOT),
  ...
  ALIAS_SXTL_8H(AARCH64_INS_ALIAS_SXTL_8H),
  ...
  ALIAS_LD1RSW(AARCH64_INS_ALIAS_LD1RSW),
  ...
  ALIAS_INCH(AARCH64_INS_ALIAS_INCH),
  ...
  ALIAS_CNTB(AARCH64_INS_ALIAS_CNTB),
  UMULLB(AARCH64_INS_UMULLB),
  ALIAS_NOP(AARCH64_INS_ALIAS_NOP),
  ...
  ALIAS_STLRB(AARCH64_INS_ALIAS_STLRB),
  ADDPL(AARCH64_INS_ADDPL),
  ALIAS_LDURH(AARCH64_INS_ALIAS_LDURH),
  ALIAS_AUTIAZ(AARCH64_INS_ALIAS_AUTIAZ),
  ORV(AARCH64_INS_ORV),
  ...
  ALIAS_UQDECW(AARCH64_INS_ALIAS_UQDECW),
  ALIAS_LDNT1SH(AARCH64_INS_ALIAS_LDNT1SH),
  RSUBHN(AARCH64_INS_RSUBHN),
  ALIAS_ST3H(AARCH64_INS_ALIAS_ST3H),
  ALIAS_STSMAXH(AARCH64_INS_ALIAS_STSMAXH),
  ALIAS_STSETLH(AARCH64_INS_ALIAS_STSETLH),
  ...
  ALIAS_ORR_4S(AARCH64_INS_ALIAS_ORR_4S),
  RETAASPPC(AARCH64_INS_RETAASPPC),
  ALIAS_SXTL2_4S(AARCH64_INS_ALIAS_SXTL2_4S),
  SMLSLL(AARCH64_INS_SMLSLL),
  SWPP(AARCH64_INS_SWPP),
  ALIAS_STUMINLB(AARCH64_INS_ALIAS_STUMINLB),
  ...
  ALIAS_SUBPT(AARCH64_INS_ALIAS_SUBPT),
  ALIAS_ST2G(AARCH64_INS_ALIAS_ST2G),
  MOVN(AARCH64_INS_MOVN),
  HVC(AARCH64_INS_HVC),
  MOV(AARCH64_INS_MOV),
  LDRSH(AARCH64_INS_LDRSH),
  ALIAS_LDAPURSH(AARCH64_INS_ALIAS_LDAPURSH),
  CNT(AARCH64_INS_CNT),
  ...
  ALIAS_CLRBHB(AARCH64_INS_ALIAS_CLRBHB),
  ALIAS_LDNT1D(AARCH64_INS_ALIAS_LDNT1D),
  ...
  ALIAS_STSETH(AARCH64_INS_ALIAS_STSETH),
  SQRDCMLAH(AARCH64_INS_SQRDCMLAH),
  SQSUBR(AARCH64_INS_SQSUBR),
  UCVTF(AARCH64_INS_UCVTF),
  ALIAS_BIC_4S(AARCH64_INS_ALIAS_BIC_4S),
  CADD(AARCH64_INS_CADD),
  ALIAS_MVN(AARCH64_INS_ALIAS_MVN),
  ...
  ALIAS_ST4H(AARCH64_INS_ALIAS_ST4H),
  ALIAS_STUMAXLB(AARCH64_INS_ALIAS_STUMAXLB),
  ...
  TSB(AARCH64_INS_TSB),
  ALIAS_LDRAB(AARCH64_INS_ALIAS_LDRAB),
  FMLALB(AARCH64_INS_FMLALB),
  SQRSHL(AARCH64_INS_SQRSHL),
  ALIAS_LDAPURSW(AARCH64_INS_ALIAS_LDAPURSW),
  LASTB(AARCH64_INS_LASTB),
  FCMNE(AARCH64_INS_FCMNE),
  ALIAS_STNT1D(AARCH64_INS_ALIAS_STNT1D),
  ALIAS_STNT1H(AARCH64_INS_ALIAS_STNT1H),
  HINT(AARCH64_INS_HINT),
  BMOPA(AARCH64_INS_BMOPA),
  ALIAS_AUTIB1716(AARCH64_INS_ALIAS_AUTIB1716),
  LDLARH(AARCH64_INS_LDLARH),
  FMS16(AARCH64_INS_FMS16),
  ALIAS_EOR(AARCH64_INS_ALIAS_EOR),
  ALIAS_LD1SW(AARCH64_INS_ALIAS_LD1SW),
  ALIAS_EON(AARCH64_INS_ALIAS_EON),
  ALIAS_STADDB(AARCH64_INS_ALIAS_STADDB),
  ALIAS_EOR3(AARCH64_INS_ALIAS_EOR3),
  ALIAS_ST4D(AARCH64_INS_ALIAS_ST4D),
  ...
  ALIAS_LDNF1H(AARCH64_INS_ALIAS_LDNF1H),
  FMLS(AARCH64_INS_FMLS),
  BRKPB(AARCH64_INS_BRKPB),
  CMPLT(AARCH64_INS_CMPLT),
  ALIAS_LDNF1D(AARCH64_INS_ALIAS_LDNF1D),
  LDXP(AARCH64_INS_LDXP),
  LD1ROW(AARCH64_INS_LD1ROW),
  LDSMINLB(AARCH64_INS_LDSMINLB),
  ALIAS_SQDECW(AARCH64_INS_ALIAS_SQDECW),
  ALIAS_LDAPURSB(AARCH64_INS_ALIAS_LDAPURSB),
  ...
  ALIAS_LD1W(AARCH64_INS_ALIAS_LD1W),
  ALIAS_NOTS(AARCH64_INS_ALIAS_NOTS),
  ALIAS_ASR(AARCH64_INS_ALIAS_ASR),
  ...
  ALIAS_DCPS2(AARCH64_INS_ALIAS_DCPS2),
  ALIAS_LDAPURB(AARCH64_INS_ALIAS_LDAPURB),
  ALIAS_STRH(AARCH64_INS_ALIAS_STRH),
  ERET(AARCH64_INS_ERET),
  SQDMULH(AARCH64_INS_SQDMULH),
  ALIAS_PACIAZ(AARCH64_INS_ALIAS_PACIAZ),
  LD1H(AARCH64_INS_LD1H),
  LDSMINH(AARCH64_INS_LDSMINH),
  ALIAS_BIC_8H(AARCH64_INS_ALIAS_BIC_8H),
  ALIAS_DCPS1(AARCH64_INS_ALIAS_DCPS1),
  CPYFMWTRN(AARCH64_INS_CPYFMWTRN),
  UMAXQV(AARCH64_INS_UMAXQV),
  SUMOPA(AARCH64_INS_SUMOPA),
  ALIAS_STZ2G(AARCH64_INS_ALIAS_STZ2G),
  ALIAS_LD1RQW(AARCH64_INS_ALIAS_LD1RQW),
  ...
  ALIAS_SQDECD(AARCH64_INS_ALIAS_SQDECD),
  ...
  ALIAS_LD1Q(AARCH64_INS_ALIAS_LD1Q),
  ...
  ALIAS_STUR(AARCH64_INS_ALIAS_STUR),
  DMB(AARCH64_INS_DMB),
  FDOT(AARCH64_INS_FDOT),
  FCVTMS(AARCH64_INS_FCVTMS),
  SMULH(AARCH64_INS_SMULH),
  ALIAS_STEORH(AARCH64_INS_ALIAS_STEORH),
  ...
  ALIAS_UQDECD(AARCH64_INS_ALIAS_UQDECD),
  ...
  ALIAS_CMP(AARCH64_INS_ALIAS_CMP),
  ALIAS_STSMAXLB(AARCH64_INS_ALIAS_STSMAXLB),
  ALIAS_LDNT1H(AARCH64_INS_ALIAS_LDNT1H),
  SETF16(AARCH64_INS_SETF16),
  ALIAS_DECD(AARCH64_INS_ALIAS_DECD),
  RCWSSETL(AARCH64_INS_RCWSSETL),
  EORV(AARCH64_INS_EORV),
  ALIAS_SXTL2_2D(AARCH64_INS_ALIAS_SXTL2_2D),
  LD1RSB(AARCH64_INS_LD1RSB),
  FMAXNM(AARCH64_INS_FMAXNM),
  FMLALL(AARCH64_INS_FMLALL),
  ALIAS_ST3D(AARCH64_INS_ALIAS_ST3D),
  ...
  ASR(AARCH64_INS_ASR),
  BRK(AARCH64_INS_BRK),
  ALIAS_STEOR(AARCH64_INS_ALIAS_STEOR),
  DECB(AARCH64_INS_DECB),
  CPYE(AARCH64_INS_CPYE),
  ALIAS_LDNF1SW(AARCH64_INS_ALIAS_LDNF1SW),
  ALIAS_SEV(AARCH64_INS_ALIAS_SEV),
  DCPS3(AARCH64_INS_DCPS3),
  ALIAS_DC(AARCH64_INS_ALIAS_DC),
  ALIAS_PRFH(AARCH64_INS_ALIAS_PRFH),
  ALIAS_PRFUM(AARCH64_INS_ALIAS_PRFUM),
  TBX(AARCH64_INS_TBX),
  ALIAS_TLBIP(AARCH64_INS_ALIAS_TLBIP),
  GCSPOPCX(AARCH64_INS_GCSPOPCX),
  FMS64(AARCH64_INS_FMS64),
  ALIAS_LD3(AARCH64_INS_ALIAS_LD3),
  LDAPRH(AARCH64_INS_LDAPRH),
  LDUMINA(AARCH64_INS_LDUMINA),
  FRINTN(AARCH64_INS_FRINTN),
  ALIAS_PTRUE(AARCH64_INS_ALIAS_PTRUE),
  ALIAS_INCW(AARCH64_INS_ALIAS_INCW),
  ...
  ALIAS_STCLRLH(AARCH64_INS_ALIAS_STCLRLH),
  SHL(AARCH64_INS_SHL),
  ALIAS_ROR(AARCH64_INS_ALIAS_ROR),
  BFMLS(AARCH64_INS_BFMLS),
  LDFF1B(AARCH64_INS_LDFF1B),
  BF1CVTLT(AARCH64_INS_BF1CVTLT),
  ALIAS_LDRH(AARCH64_INS_ALIAS_LDRH),
  SBCLT(AARCH64_INS_SBCLT),
  ALIAS_CLREX(AARCH64_INS_ALIAS_CLREX),
  ALIAS_MUL(AARCH64_INS_ALIAS_MUL),
  ALIAS_NEG(AARCH64_INS_ALIAS_NEG),
  USUBL(AARCH64_INS_USUBL),
  ALIAS_MOVT(AARCH64_INS_ALIAS_MOVT),
  LD2W(AARCH64_INS_LD2W),
  ALIAS_SMNEGL(AARCH64_INS_ALIAS_SMNEGL),
  ALIAS_PSSBB(AARCH64_INS_ALIAS_PSSBB),
  ADDVL(AARCH64_INS_ADDVL),
  UMAX(AARCH64_INS_UMAX),
  RCWSWP(AARCH64_INS_RCWSWP),
  ALIAS_UXTL2_4S(AARCH64_INS_ALIAS_UXTL2_4S),
  ...
  ALIAS_AUTIBZ(AARCH64_INS_ALIAS_AUTIBZ),
  ...
  ALIAS_LD4B(AARCH64_INS_ALIAS_LD4B),
  ...
  ALIAS_UMNEGL(AARCH64_INS_ALIAS_UMNEGL),
  ALIAS_LDURSB(AARCH64_INS_ALIAS_LDURSB),
  FDIVR(AARCH64_INS_FDIVR),
  ALIAS_STCLRH(AARCH64_INS_ALIAS_STCLRH),
  CASP(AARCH64_INS_CASP),
  CLS(AARCH64_INS_CLS),
  LUTI2(AARCH64_INS_LUTI2),
  LDUMINL(AARCH64_INS_LDUMINL),
  GCSPUSHX(AARCH64_INS_GCSPUSHX),
  ALIAS_STLURH(AARCH64_INS_ALIAS_STLURH),
  FCVTL2(AARCH64_INS_FCVTL2),
  TBLQ(AARCH64_INS_TBLQ),
  ALIAS_CNTH(AARCH64_INS_ALIAS_CNTH),
  LDRAA(AARCH64_INS_LDRAA),
  ADC(AARCH64_INS_ADC),
  ALIAS_LDURSW(AARCH64_INS_ALIAS_LDURSW),
  ALIAS_STLLRB(AARCH64_INS_ALIAS_STLLRB),
  ALIAS_LD1SB(AARCH64_INS_ALIAS_LD1SB),
  ...
  ALIAS_CNEG(AARCH64_INS_ALIAS_CNEG),
  ALIAS_LDNT1SW(AARCH64_INS_ALIAS_LDNT1SW),
  ALIAS_ST2Q(AARCH64_INS_ALIAS_ST2Q),
  ...
  ALIAS_SQDECH(AARCH64_INS_ALIAS_SQDECH),
  ...
  ALIAS_STUMINB(AARCH64_INS_ALIAS_STUMINB),
  ALIAS_INCB(AARCH64_INS_ALIAS_INCB),
  ...
  ALIAS_ISB(AARCH64_INS_ALIAS_ISB),
  ...
  ALIAS_UQDECH(AARCH64_INS_ALIAS_UQDECH),
  ...
  INS(AARCH64_INS_INS),
  ALIAS_BSL2N(AARCH64_INS_ALIAS_BSL2N),
  ...
  ALIAS_BIC_4H(AARCH64_INS_ALIAS_BIC_4H),
  LD4(AARCH64_INS_LD4),
