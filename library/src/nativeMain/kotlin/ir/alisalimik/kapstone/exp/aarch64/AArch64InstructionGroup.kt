...
actual enum class AArch64InstructionGroup(override val value: UInt) : INumericEnum {
  INVALID(AARCH64_GRP_INVALID),
  JUMP(AARCH64_GRP_JUMP),
  CALL(AARCH64_GRP_CALL),
  RET(AARCH64_GRP_RET),
  INT(AARCH64_GRP_INT),
  PRIVILEGE(AARCH64_GRP_PRIVILEGE),
  BRANCH_RELATIVE(AARCH64_GRP_BRANCH_RELATIVE),
