...
internal actual suspend fun loadCapstoneModule(): Promise<CapstoneModuleInstance> {
    ...
    return Promise { resolve, reject ->
        ...
        importPromise.then { module: dynamic ->
            // Assign to globals to satisfy the capstoneModule() factory expectations
            if (module != null) {
                js("if (typeof global !== 'undefined') global.CapstoneModule = module.CapstoneModule || module.default || module;")
                js("if (typeof window !== 'undefined') window.CapstoneModule = module.CapstoneModule || module.default || module;")
            }
